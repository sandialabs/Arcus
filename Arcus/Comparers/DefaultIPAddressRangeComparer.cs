...
{
    /// <summary>
    ///     Default implementation of a <see cref="Comparer{T}" />
    /// </summary>
    public class DefaultIPAddressRangeComparer : Comparer<IPAddressRange>
    {
        ...
        public override int Compare(IPAddressRange x,
                                    IPAddressRange y)
        {

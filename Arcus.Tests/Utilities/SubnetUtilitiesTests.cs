...
namespace Arcus.Tests.Utilities
{
    ...
    public class SubnetUtilitiesTests
    {
        ...
        [Test]
        public void FewestConsecutiveSubnetsForNullAlphaTest()
        {
            Assert.Throws<ArgumentNullException>(() => SubnetUtilities.FewestConsecutiveSubnetsFor(null, IPAddress.Any));
        }
        ...
        [Test]
        public void LargestSubnetLargestOfThreeOneTest()
        {
            // Arrange
            var expected = new Subnet(IPAddress.Any, 16);
        ...
        [Test]
        public void SmallestSubnetAmbiguousSmallestOfThreeOneTest()
        {
            // Arrange
            ...
            // Assert
            Assert.AreEqual(new Subnet(IPAddress.Any, 32), result);
        }

        [Test]
        public void SmallestSubnetSmallestOfNoneTest()
        {
            // Arrange
            var subnets = new Subnet[] {};
        ...
        [Test]
        public void SmallestSubnetSmallestOfOneTest()
        {
            // Arrange
            var expected = new Subnet(IPAddress.Any, 16);

...
namespace Arcus.Tests
{
    public class IPAddressRangeTests
    {
        ...
        public void Equals_IPAddressRange_Test(bool expected,
                                               string xHead,
                                               string xTail,
                                               string yHead,
                                               string yTail)
        ...
        public static IEnumerable<object[]> ToString_Format_Test_Values()
        {
            ...
            {
                foreach (var ipAddressRange in Ipv4AddressRanges()
                    .Concat(Ipv6AddressRanges()))
                {
                    yield return new object[] {$"{ipAddressRange.Head} - {ipAddressRange.Tail}", format, CultureInfo.CurrentCulture, ipAddressRange};
                }
            }

...
namespace Arcus.Tests
{
    public class SubnetTests
    {
        ...
        public SubnetTests(ITestOutputHelper testOutputHelper)
        {
        ...
        [InlineData("::/64", "::/64")]
        [InlineData("::/0", "::/0")]
        public void ToString_Test(string expected,
                                  string input)
        {
            // Arrange
            // Act
        ...
        public static IEnumerable<object[]> UsableHostAddressCount_Test_Values()
        {
            foreach (var ipAddress in IPv4Addresses())
            {
                for (var i = 0; i <= 32; i++)
                {
                    ...
                    var count = routePrefix < 2
                                    ? BigInteger.Zero
                                    : BigInteger.Subtract(BigInteger.Pow(2, routePrefix), 2);
        ...
        public void UsableHostAddressCount_Test(BigInteger expected,
                                                Subnet subnet)
        {
            // Arrange
        ...
        public void Contains_IPAddress_Test(bool expected,
                                            string subnetString,
                                            string containsIPAddressString)
        {
            // Arrange
            var subnet = Subnet.Parse(subnetString);
            var containsIPAddress = containsIPAddressString != null
                                        ? IPAddress.Parse(containsIPAddressString)
                                        : null;
        ...
        public void Contains_Subnet_Test(bool expected,
                                         string subnetString,
                                         string containsSubnetString)
        {
            // Arrange
            var subnet = Subnet.Parse(subnetString);
            var containsSubnet = containsSubnetString != null
                                     ? Subnet.Parse(containsSubnetString)
                                     : null;
        ...
        public void TryIPv4FromPartial_Test(Subnet expected,
                                            string input)
        {
            // Arrange
        ...
        public static IEnumerable<object[]> TryIPv6FromPartial_Test_Values()
        {
            ...
            yield return new object[] {new[] {Subnet.Parse("2001:0db8:85a3:0042:1000:0001:0370:7334/128")}, "2001:0db8:85a3:0042:1000:0001:0370:7334/128"};
            ...
            for (var hextetCount = 1; hextetCount <= 8; hextetCount++)
            {
                ...
                {
                    var enumerable = hextets.Take(hextetCount)
                                            .Select(s => new string(s.SkipWhile(c => c == '0')
                                                                     .ToArray()));
                    var trimmedLeadingZero = string.Join(":", enumerable);
                    var subnet = hextetCount < 8
                ...
                if (!string.IsNullOrEmpty(inputString)   // no match for an empty string
                    && inputString != hextets[0]) // TODO should this work, a hextet w/o any ':'? Unsure
                {
                    yield return new object[] {subnets, inputString};
                }
            }
        ...
        public void TryIPv6FromPartial_Test(IEnumerable<Subnet> expected,
                                            string input)
        {
            // Arrange
            // Act
...
#pragma warning restore CS0618
        ...
        public void Ctor_IPAddress_Test(Subnet expected,
                                        IPAddress address)
        {
            // Arrange
            // Act
        ...
        [InlineData("::", -1)]
        [InlineData("::", 129)]
        public void Ctor_IPAddress_Int_IntOutOfRange_Throws_ArgumentNullException_Test(string address,
                                                                                       int routingPrefix)
        {
        ...
        {
            yield return new object[] {new Subnet(IPAddress.Parse("0.0.0.0"), 0), IPAddress.Parse("0.0.0.0"), IPAddress.Parse("255.255.255.255")};
            yield return new object[] {new Subnet(IPAddress.Parse("::"), 0), IPAddress.Parse("::"), IPAddress.Parse("FFFF:FFFF:FFFF:FFFF:FFFF:FFFF:FFFF:FFFF")};
        ...
        public void Ctor_IPAddress_IPAddress_Test(Subnet expected,
                                                  IPAddress primary,
                                                  IPAddress secondary)
        {
            // Arrange
        ...
        public void Ctor_IPAddress_IPAddress_Null_Input_Throws_ArgumentNullException_Test(string primary,
                                                                                          string secondary)
        {
            // Arrange
            ...
            Assert.Throws<ArgumentNullException>(() =>
                                                 {
                                                     var subnet = new Subnet(primaryAddress, secondaryAddress);
                                                 });
        }
        ...
        [InlineData("ff::dc", "::")]
        public void Ctor_IPAddress_IPAddress_Input_Invalid_Ordering_Throws_InvalidOperationException_Test(string primary,
                                                                                                          string secondary)
        {
            // Arrange
        ...
        public void Ctor_IPAddress_IPAddress_MismatchAddressFamily_Throws_ArgumentException_Test(string primary,
                                                                                                 string secondary)
        {
            // Arrange
            var primaryAddress = IPAddress.Parse(primary);
        ...
        public void FromBytes_Bytes_Bytes_Test(Subnet expected,
        ...
        public void FromBytes_Null_Input_Throws_ArgumentNullException_Test(byte[] lowAddressBytes,
                                                                           byte[] highAddressBytes)
        {
            // Arrange
            // Act
        ...
        public void FromBytes_Invalid_Input_Throws_ArgumentException_Test(byte[] lowAddressBytes,
                                                                          byte[] highAddressBytes)
        {
            // Arrange
            // Act
        ...
        public void TryFromBytes_Bytes_Bytes_Test(bool expectedSuccess,
        ...
        public void Parse_String_Test(Subnet expected,
                                      string input)
        {
            // Arrange
        ...
        public void TryParse_String_Test(Subnet expected,
                                         string input)
        {
            // Arrange
        ...
        public void Parse_String_Int_Test(Subnet expected,
        ...
        public void TryParse_String_Int_Test(bool expectedSuccess,
                                             Subnet expectedSubnet,
                                             string addressString,
                                             int routePrefix)
        {
        ...
        public void Parse_String_String_Test(Subnet expected,
                                             string low,
                                             string high)
        {
            // Arrange
        ...
        [InlineData(null, null)]
        public void Parse_String_String_NullAddressString_Throws_ArgumentNullException_Test(string low,
                                                                                            string high)
        {
            // Arrange
            // Act
        ...
        public void Parse_String_String_BadAddressFormat_Throws_ArgumentException_Test(string low,
                                                                                       string high)
        {
            // Arrange
            // Act
        ...
        [InlineData("::", "192.168.1.1")]
        public void Parse_String_String_MisMatchAddressFamily_Throws_ArgumentException_Test(string low,
                                                                                            string high)
        {
            // Arrange
            // Act
        ...
        [InlineData("::20", "::")]
        public void Parse_String_String_InvalidRange_Throws_InvalidOperationException_Test(string low,
                                                                                           string high)
        {
            // Arrange
            // Act
        ...
        public void TryParse_String_String_Test(Subnet expected,
                                                string low,
                                                string high)
        {
            // Arrange
        ...
        public void Equals_Subnet_Test(bool expected,
                                       Subnet subnetA,
                                       Subnet subnetB)
        {
            // Arrange
        ...
        public void FromNetMask_Test(Subnet expected,
        ...
        public void TryFromNetMask_Test(bool expectedSuccess,
                                        Subnet expectedSubnet,
                                        IPAddress networkPrefix,
                                        IPAddress netmask)
        {
        ...
        public static IEnumerable<object[]> ToString_Format_Test_Values()
        {
            ...
            {
                foreach (var subnet in Ipv4AddressSubnets()
                    .Concat(Ipv6AddressSubnets()))
                {
                    yield return new object[] {$"{subnet.NetworkPrefixAddress}/{subnet.RoutingPrefix}", format, CultureInfo.CurrentCulture, subnet};
                }
            }
                    ...
                    yield return new object[]
                                 {
                                     ...
                                     format, CultureInfo.CurrentCulture, subnet
                                 };
                }
            }
        ...
        public void GetHashCode_Test(bool expectedEqual,
                                     Subnet left,
                                     Subnet right)
        {
            // Arrange
